...
package talendgithub.job_test_0_1;
...
public class job_Test implements TalendJob {
	...
	private final String projectName = "TALENDGITHUB";
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tWarn_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tWarn_1.append("MESSAGE" + " = " + "\"Hello word !\"");
				...
				try {
					...
					resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN",
							"", "Hello word !", "", "");
					log.warn("tWarn_1 - " + ("Message: ") + ("Hello word !") + (". Code: ") + (42));
					globalMap.put("tWarn_1_WARN_MESSAGES", "Hello word !");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_bJqGgIZ0EfC1H8-HdBkCJg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-08-31T14:12:46.212290Z");
		...
		try {
			...
			java.io.InputStream inContext = job_Test.class.getClassLoader()
					.getResourceAsStream("talendgithub/job_test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
		...
		log.info("TalendJob: 'job_Test' - Started.");
		...
		log.info("TalendJob: 'job_Test' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 52689 characters generated by Talend Cloud Data Management Platform on the 31
 * août 2025 à 16:12:46 CEST
 ************************************************************************************************/